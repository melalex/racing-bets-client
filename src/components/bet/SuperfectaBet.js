...
export default class SuperfectaBet extends Component {
    constructor(props) {
        super(props);
    ...
    betFromForm(form) {
        ...
        this.participant4 = Number(form.participant4);
            ...
            <Row className="big-margin-top big-margin-bot">
                <Col md={{size: 6}}>
                    <AvForm onValidSubmit={this.handleForm}>
                        ...
                        <AvGroup row>
                            <Label for="participant4" sm={4}>{I18n.t('participant')} 4</Label>
                            <Col sm={8}>
                                <AvField type="select" name="participant4" value={this.participant4} required>
                                    <option>{}</option>
                                    {options}
                                </AvField>
                            </Col>
                ...
                <Col md={{size: 6}}>
                    <h1>{I18n.t('desc')}</h1>
                    <p>{I18n.t('superfectaDesc')}</p>

                    <h1>{I18n.t('suggested')}</h1>
                    <p>{I18n.t('superfectaSuggested')}</p>
                </Col>
            </Row>
        );
    }
